...
namespace Core.Devices
{
    class Switch : Node
    {
        ...
        [SerializeField] private Transform offState;
        [SerializeField] private Transform onState;
        ...
        protected override void Update()
        {
            ...
            onState.gameObject.SetActive(state);
            offState.gameObject.SetActive(!state);
        }
